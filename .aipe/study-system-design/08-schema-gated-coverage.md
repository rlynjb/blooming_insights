...
→ [audit.md](./audit.md) (request-response-and-data-flow + scale-bottlenecks lenses — the gate is what bounds the agent's `maxToolCalls: 6` budget to runnable categories) · [01-request-flow.md](./01-request-flow.md) · [05-streaming-ndjson.md](./05-streaming-ndjson.md) · [06-multi-agent-orchestration.md](./06-multi-agent-orchestration.md) · `.aipe/study-system-design-dsa/02-dsa/07-coverage-gate.md`
