...
---
Updated: 2026-05-29 — Corrected drifted refs: the severity sort+slice `monitoring.ts:102`→`:119`, and `insights.ts` `listInsights`/`putInsights` `:51`/`:29`→`:52`/`:30`. Generic sections unchanged.
