...
/** The two runtime modes the briefing supports:
...
export type BriefingMode = 'demo' | 'live-bloomreach';
...
export function useBriefingStream(
  ...
  useEffect(() => {
    ...
    // tagged with `?mode=live-bloomreach` so the route picks the Bloomreach
